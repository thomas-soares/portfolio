      ...
      <main>
        <section>
          ...
          <p>
            ...
            desenvolvedores back-end para criar interfaces de usuário atraentes
            e funcionais para aplicativos da web. Utilizo tecnologias como HTML,
            CSS, Javascript, Typescript, React, Next.js, React Native, Graphql,
            Node.js, Zustand, Redux, Tailwind CSS, Styled Components, Jest,
            entre outras.
          </p>
          <p>
        ...
        <section>
          ...
          <article>
            ...
            <p>
              ...
              internet banking originalmente em Flutter Web. Também
              desenvolvemos o Design System baseado no Figma. O sistema foi
              reescrito com React, Vite, Tailwind CSS, Zustand, Storybook, Jest,
              TanStack Query, ESLint e Prettier.
            </p>
          </article>
          ...
          <article>
            ...
            <p>
              Outsourcing para cliente de petróleo e gás, atuando na migração de
              um sistema legado em ASP para Angular. Utilização de Angular
              Material, back-end em .NET e Oracle com Dapper e Entity Framework.
              Paralelamente, estudei mais React e Next.js, minhas principais
              especialidades.
            </p>
          </article>
          ...
          <article>
            ...
            <p>
              ...
              e-commerce feito em Next.js e em apps das marcas utilizando React
              Native. Tecnologias: Typescript, React, Next.js, React Native,
              GraphQL, Node.js, Redux, Styled Components, Jest etc.
            </p>
          </article>
          ...
          <article>
            ...
            <p>
              Atuação na marca Americanas Empresas, desenvolvendo novas features
              e modernizando soluções do e-commerce usando Typescript, React,
              Next.js, Node.js, Redux, Styled Components, Jest, GraphQL.
            </p>
          </article>
          ...
          <article>
            ...
            <p>
              Atuei na versão web de um sistema legado desenvolvido em NodeJS e
              AngularJS. Também trabalhei em um site com indicadores para
              clientes de ERP em Ruby. Participei brevemente do desenvolvimento
              de emissão de documentos eletrônicos (MDFE e CTE) via integrador
              Java.
            </p>
          </article>
          ...
          <article>
            ...
            <p>
              Tecnologias utilizadas: HTML, CSS, Javascript, Jquery, MySQL, PHP,
              OpenCart 1.5.x e migração para Magento.
            </p>
          </article>
        </section>
