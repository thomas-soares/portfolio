            ...
            <Reveal>
              <Card className="border-(--border) bg-(--surface) text-foreground shadow-xl shadow-(color:--shadow-medium)">
                ...
                <CardContent className="space-y-4 text-(--muted)">
                  <p>
                    Como desenvolvedor front-end, trabalho em conjunto com
                    outros membros do time de desenvolvimento, incluindo
                    designers e desenvolvedores back-end, para criar interfaces
                    de usuário atraentes e funcionais para aplicativos da web.
                    Utilizo tecnologias HTML, CSS, Javascript, Typescript,
                    React, Next.js, React Native, Graphql, Node.js, Zustand,
                    Redux, Tailwind CSS, Styled Components, Jest, entre outras.
                  </p>
                  <p>
                    Dentro de um time ágil, sigo rotinas Scrum que incluem
                    reuniões diárias de stand-up, planejamento de sprint,
                    revisão de sprint e retrospectiva. Trabalho em estreita
                    colaboração com outros membros do time para garantir que os
                    requisitos do usuário sejam atendidos em cada iteração.
                  </p>
                  <p>
                    Em resumo, como desenvolvedor front-end com mais de 12 anos
                    de experiência, meu trabalho inclui desenvolver interfaces
                    de usuário usando tecnologias como React, trabalhando em
                    colaboração com outros membros do time de desenvolvimento
                    para atender às necessidades do usuário e seguindo rotinas
                    Scrum para garantir a entrega do produto de forma ágil e
                    eficiente.
                  </p>
                </CardContent>
              </Card>
                ...
                <CardContent className="space-y-5">
                  <Reveal delay={0}>
                    <article className="space-y-3 rounded-3xl border border-(--border) bg-(--surface) p-5">
                      ...
                      <p className="text-(--muted)">
                        Responsável pela arquitetura, desenvolvimento e evolução
                        do frontend utilizando React, Next.js e TypeScript, com
                        integração a NestJS e Protheus (TOTVS).
                      </p>
                      <p className="text-(--muted)">
                        Criação de Design System próprio com Storybook,
                        padronização de componentes reutilizáveis e foco em
                        acessibilidade e escalabilidade.
                      </p>
                      <p className="text-(--muted)">
                        Implementação de testes unitários, integração e E2E,
                        além de práticas de observabilidade, monitoramento e
                        rastreamento de erros.
                      </p>
                      <p className="text-(--muted)">
                        Otimizações contínuas de performance e Web Core Vitals
                        (code splitting, lazy loading, cache estratégico),
                        garantindo alta confiabilidade e experiência do usuário
                        em ambiente crítico de negócio.
                      </p>
                    </article>
                  </Reveal>
                  ...
                  <Reveal delay={0.06}>
                    <article className="space-y-3 rounded-3xl border border-(--border) bg-(--surface) p-5">
                      ...
                      <p className="text-(--muted)">
                        Trabalhei como desenvolvedor Front-end em um projeto
                        para um cliente do setor financeiro, focado na migração
                        de uma aplicação de internet banking originalmente feita
                        em Flutter Web. Desenvolvemos também o Design System, de
                        acordo com o que foi proposto através do Figma. O
                        sistema foi reescrito utilizando tecnologias modernas,
                        incluindo: React, Vite, Tailwind CSS, Zustand,
                        Storybook, Jest, TanStack Query (React Query), ESLint e
                        Prettier.
                      </p>
                    </article>
                  </Reveal>
                  ...
                  <Reveal delay={0.12}>
                    <article className="space-y-3 rounded-3xl border border-(--border) bg-(--surface) p-5">
                      ...
                      <p className="text-(--muted)">
                        Atuei como outsourcing para um cliente do ramo de
                        petróleo e gás, trabalhando na migração de um sistema
                        legado em ASP para uma solução moderna em Angular, foi
                        utilizado Angular Material, back-end foi desenvolvido em
                        .NET e o gerenciamento de dados é feito no Oracle
                        utilizando Dapper e Entity Framework. Além disso, segui
                        estudando React e Next.js, que são as tecnologia em que
                        sou mais especializado.
                      </p>
                    </article>
                  </Reveal>
                  ...
                  <Reveal delay={0.18}>
                    <article className="space-y-3 rounded-3xl border border-(--border) bg-(--surface) p-5">
                      ...
                      <p className="text-(--muted)">
                        ...
                        farmacêutico, atuava em um projeto de e-commerce feito
                        em Next.js e no app das duas marcas do cliente que foi
                        feito em React Native, utilizavamos também Typescript,
                        React, Next.js, React Native, Graphql, Node.js, Redux,
                        Styled Components, Jest, além de outras tecnologias.
                      </p>
                    </article>
                  </Reveal>
                  ...
                  <Reveal delay={0.24}>
                    <article className="space-y-3 rounded-3xl border border-(--border) bg-(--surface) p-5">
                      ...
                      <p className="text-(--muted)">
                        ...
                        existiam no e-commerce que foi desenvolvido com
                        tecnologias como Typescript, React, Next.js, Node.js,
                        Redux, Styled Components, Jest, GraphQL, entre outras.
                      </p>
                    </article>
                  </Reveal>
                  ...
                  <Reveal delay={0.3}>
                    <article className="space-y-3 rounded-3xl border border-(--border) bg-(--surface) p-5">
                      ...
                      <p className="text-(--muted)">
                        ...
                        DjangoCMS, atuando com metodologia ágil, rodando scrum
                        em times compostos por Product Owner, Scrum Master e
                        desenvolvedores, trabalhamos com tecnologias como
                        Django, DjangoCMS, SASS, REST, Docker, Git, Gitlab e
                        Micro serviços.
                      </p>
                      <p className="text-(--muted)">
                        Também já trabalhei anteriormente em projetos que
                        utilizavam diversas tecnologias como Drupal 8,
                        Wordpress, Laravel, Lumen, Embedded JavaScript
                        templating, Jenkins, Gulp, Grunt, NPM, Yarn, HTML, CSS,
                        Javascript, Jquery, MySql, SQLite, PHP, Python.
                      </p>
                      <p className="text-(--muted)">
                  ...
                  <Reveal delay={0.36}>
                    <article className="space-y-3 rounded-3xl border border-(--border) bg-(--surface) p-5">
                      ...
                      <p className="text-(--muted)">
                        ...
                        dependências que visam facilitar o desenvolvimento e/ou
                        a implementação de funcionalidades. Trabalhei conforme
                        necessário em um site com diversos indicadores para os
                        nossos clientes que utilizam o ERP que foi desenvolvido
                        em Ruby.
                      </p>
                      <p className="text-(--muted)">
                        Trabalhei brevemente no desenvolvimento da emissão de
                        novos documentos eletrônicos como MDFE (manifesto de
                        documento eletrônico) e CTE (conhecimento de transporte)
                        por integrador do ERP desenvolvido em Java.
                      </p>
                    </article>
                  </Reveal>
                  ...
                  <Reveal delay={0.42}>
                    <article className="space-y-3 rounded-3xl border border-(--border) bg-(--surface) p-5">
                      ...
                      <p className="text-(--muted)">
                        Tecnologias que tive contato: HTML, CSS, SASS, LESS,
                        Stylus, Bootstrap 3, Foundation, BEM (Block, Element,
                        Modifier), Javascript, Jquery, Gulp, Grunt, Backbone,
                        PHP, Kohana, Wordpress, C#, .Net, SQL Server, MySQL,
                        Jenkins, Composer, NPM, Bower, GIT.
                      </p>
                    </article>
                  </Reveal>
                  ...
                  <article className="space-y-3 rounded-3xl border border-(--border) bg-(--surface) p-5">
                    ...
                    <p className="text-(--muted)">
                      Tecnologias que tive contato: HTML, CSS, Javascript,
                      Jquery, MySQL, PHP, Opencart na versão 1.5.x, Migração
                      para Magento.
                    </p>
                  </article>
                </CardContent>
